package org.generalrelativity.thread
{
	...
	final public class GreenThread extends EventDispatcher
	{
		 ...
		 * */
		public function GreenThread( processes:Array, hertz:int, share:Number = 0.5, isDiagnostic:Boolean = false )
		{
			super();
			...
			for( var i:int = n - 1; i > -1; i-- )
			{
				...
				try
				{
					...
					else
					{
						...
						var bool1:Boolean = (getTimer() - processStart) < processAllocation;
